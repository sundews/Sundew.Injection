...
namespace OverallSuccess
{
    ...
    {
        private const int BucketSize = 41;
            ...
            global::OverallSuccess.ResolveRootFactory resolveRootFactory)
        {
            this.resolverItems = global::OverallSuccess.SundewInjection.ResolverItemsFactory.Create(
                ...
                new global::OverallSuccess.SundewInjection.ResolverItem(typeof(global::OverallSuccessDependency.Dependency), () => dependencyFactory.Create()),
                new global::OverallSuccess.SundewInjection.ResolverItem(typeof(global::OverallSuccessDependency.ManualMultipleDependency), () => manualMultipleDependencyFactory.CreateNewInstance()),

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DistinctSuccessFixture.cs" company="Sundews">
...
[TestFixture]
public class DistinctSuccessFixture
{
    [Test]
    public Task VerifyGeneratedSources()
    {
        var compilation = TestProjects.DistinctSuccess.FromCurrentDirectory.Value;

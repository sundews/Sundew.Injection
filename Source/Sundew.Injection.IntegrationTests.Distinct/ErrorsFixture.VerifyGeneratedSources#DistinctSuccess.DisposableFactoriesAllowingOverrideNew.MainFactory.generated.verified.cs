...
namespace DistinctSuccess.DisposableFactoriesAllowingOverrideNew
{
    ...
    public partial class MainFactory : global::System.IDisposable, global::System.IAsyncDisposable, global::Sundew.Injection.IGeneratedFactory
    {
        ...
        public MainFactory()
        {
            this.lifecycleHandler = new global::DisposableFactoriesAllowingOverrideNew.SundewInjection.LifecycleHandler(default(global::Sundew.Injection.IInitializationParameters), default(global::Sundew.Injection.IDisposalParameters));
        }

...
internal sealed class FactoryMethodRegistrationBuilder
{
    ...
    {
        this.registrations.Add(new FactoryMethodRegistration(referencedType, targetType, scope, method, accessibility, isNewOverridable, factoryMethodName));
        return this;
    }

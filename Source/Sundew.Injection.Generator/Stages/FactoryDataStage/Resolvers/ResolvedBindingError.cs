...
{
    internal sealed record ParameterError(DefiniteType Type, string ParameterName, ValueArray<ParameterSource> ParameterSources) : ResolvedBindingError;

    internal sealed record Error(BindingError BindingError) : ResolvedBindingError;
}
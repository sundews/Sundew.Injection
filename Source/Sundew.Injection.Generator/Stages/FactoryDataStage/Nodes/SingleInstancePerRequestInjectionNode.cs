    ...
    string? ParentName) : InjectionNode(ParentName), IHaveParameters
{
    ...
    public bool Equals(SingleInstancePerRequestInjectionNode? other)
    {
    ...
    {
        return HashCode.Combine(base.GetHashCode(), this.TargetType, this.TargetReferenceType, this.Parameters, this.CreationSource, this.ParameterNodeOption, this.OverridableNewParametersOption);
    }
}